...
# Acessa o índice 0 da lista E DEPOIS a chave 'uf' desse dicionário (Saída: Rio de Janeiro)
print(brasil[0]['uf'])

# Acessa o índice 1 da lista E DEPOIS a chave 'sigla' desse dicionário (Saída: SP)
